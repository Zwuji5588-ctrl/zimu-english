...
const EMOJI_SVG = {
  // UI icons
  '🔍': '<svg wf="16" hf="16" vb="0 0 24 24" fill="none" stroke="currentColor" sw="2" lc="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>',
  ...
  '🔊': '<svg wf="16" hf="16" vb="0 0 24 24" fill="none" stroke="currentColor" sw="2" lc="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></svg>',
  '📖': '<svg wf="16" hf="16" vb="0 0 24 24" fill="none" stroke="currentColor" sw="2" lc="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>',
  '🎧': '<svg wf="16" hf="16" vb="0 0 24 24" fill="none" stroke="currentColor" sw="2" lc="round"><path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3z"/><path d="M3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/></svg>',
  '🎤': '<svg wf="16" hf="16" vb="0 0 24 24" fill="none" stroke="currentColor" sw="2" lc="round"><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 10a7 7 0 0 0 14 0"/><path d="M8 21h8"/><path d="M12 17v4"/></svg>',
  ...
  '✅': '<svg wf="16" hf="16" vb="0 0 24 24" fill="none" stroke="currentColor" sw="2" lc="round"><polyline points="20 6 9 17 4 12"/></svg>',
  '❌': '<svg wf="16" hf="16" vb="0 0 24 24" fill="none" stroke="currentColor" sw="2" lc="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',
